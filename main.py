...
player_index = menu.get_selection(
    players,
    title="GAW Turtle Radar",
    subtitle="By [CVW-69] Llama")
target = players[player_index]
# target="[joss]"

turtles = []
tt.bgcolor("black")
tt.setup(width=600, height=600, startx=300, starty=100)
